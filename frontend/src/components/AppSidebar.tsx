import { HomeIcon, TerminalIcon, SettingsIcon, DownloadIcon, PaletteIcon } from "lucide-react"
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
...
const navItems = [
  ...
  { title: "Spectrum", icon: PaletteIcon, page: "spectrum" as const },
    ...
    <Sidebar>
      <SidebarHeader className="px-4 py-3">
        <div className="flex items-center gap-2">
          <span className="text-sm font-semibold">Spectry</span>
